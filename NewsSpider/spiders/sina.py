...
class SinaSpider(scrapy.Spider):
    ...
    def parse(self, response, **kwargs):
        ...
        for data in data_list:
            ...
            news_item = NewsItem()
            # news_item['news_id'] = 0
            news_item['news_brief'] = data['intro']
            news_item['news_comments'] = data.get('comment_total', 0)
            news_item['news_cover'] = data['img']['u']
            news_item['news_img'] = [l['u'] for l in data['images']]
            news_item['news_keywords'] = data['keywords'] 
            news_item['news_link'] = data['url']
            news_item['news_media'] = data['media_name']
    ...
    def parse_news(self, response):
        ...
        news_item['news_content'] = [re.sub(r'\u3000+', '', line) for line in news_item['news_content']]
        yield news_item